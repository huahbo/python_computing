...
Python 讲统计 & 附录 \\
\href{https://github.com/huahbo/python_computing}{课程仓库参考（原：南瓜书（《机器学习》公式推导））}
& 与周志华《机器学习》配套的公式推导详解 & 第8章 scikit-learn \\
\href{https://github.com/huahbo/python_computing}{课程仓库参考（原：开源社区
图深度学习（葡萄书））} & 中文开源书，进阶图神经网络 & 第6章 NetworkX \\
\href{https://github.com/huahbo/python_computing}{课程仓库参考（原：李宏毅机器学习（开源社区整理））}
& 中文讲义，串起 ML 与 DL 的``为什么'' & 第8章 scikit-learn \\
\href{https://github.com/huahbo/python_computing}{课程仓库参考（原：李宏毅机器学习（开源社区））}
& 中文讲义，机器学习到深度学习衔接 & 第8章 scikit-learn \\
\href{https://github.com/huahbo/python_computing}{课程仓库参考（数学建模导论）}
& 后续课程 & 第1章 NumPy、第3章 SciPy、第4章 Pandas \\
\href{https://github.com/huahbo/python_computing}{课程仓库参考（数学建模导论：第
1 章 Numpy 与线性代数）} & 下游对齐 & 附录 \\
\href{https://github.com/huahbo/python_computing}{课程仓库参考（数学建模导论：第
4 章复杂网络与图论模型）} & 下游对齐 & 附录 \\
\href{https://github.com/huahbo/python_computing}{课程仓库参考（数学建模导论：第
7 章权重/评价、第 9 章统计模型）} & 下游对齐 & 附录 \\
\href{https://github.com/huahbo/python_computing}{课程仓库参考（本课程主仓库）}
...
\href{https://github.com/huahbo/python_computing}{课程仓库参考（原：Grape-book（图深度学习））}
...
\href{https://github.com/huahbo/python_computing}{课程仓库参考（原：开源社区
聪明办法学 Python v2）} & 前置 Python 课程 & 第4章 Pandas、第8章
scikit-learn \\
\href{https://github.com/huahbo/python_computing}{课程仓库参考（原：社区时间序列相关笔记）}
& 时间序列特征与规则入门 & 第7章 Statsmodels \\
\href{https://github.com/huahbo/python_computing}{课程仓库参考（原：聪明办法学
Python v2（开源社区））} & 前置课程：Chap0 安装、Chap1 启航、Chap2-6
基础语法 & 第0章 前置基础 \\
\href{https://github.com/huahbo/python_computing}{课程仓库参考（原：聪明办法学
Python v2）} & 前置课程 & 第1章 NumPy、第2章 SymPy、第7章 Statsmodels \\
\href{https://github.com/huahbo/python_computing}{课程仓库参考（原：聪明办法学
