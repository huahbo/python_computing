...
Gallery 官方示例} & 每个图型含完整可运行源码 & 第5章 Matplotlib \\
\href{https://matplotlib.org/stable/gallery/index.html}{Matplotlib
...
\href{https://www.statsmodels.org/stable/user-guide.html}{Statsmodels in
Python (教育向)} & 官方逐步教学 & 第7章 Statsmodels \\
...
库简介与总入口 & 第7章 Statsmodels \\
\href{https://www.statsmodels.org/stable/examples/index.html}{Statsmodels
官方示例 Notebooks} & 直接可跑的 notebook，含回归/诊断/时间序列 & 第7章
Statsmodels \\
...
scikit-learn \\
\href{https://scikit-learn.org/stable/user_guide.html}{scikit-learn User
Guide} & 官方模型/评估 & 附录 \\
...
\href{https://docs.scipy.org/doc/scipy/reference/}{scipy.optimize /
scipy.integrate 官方文档} & 函数 API & 附录 \\
...
Science Handbook} & 数据科学视角，可作延伸 & 第6章 NetworkX \\
...
NumPy、第3章 SciPy、第4章 Pandas \\
\href{https://github.com/jakevdp/PythonDataScienceHandbook}{Python Data
Science Handbook（Jake VanderPlas）} & 第 4 章 Matplotlib、第 5 章
Seaborn，Notebook 形式 & 第5章 Matplotlib、第8章 scikit-learn \\
\href{https://github.com/jakevdp/PythonDataScienceHandbook}{Python Data
Science Handbook（符号计算附录）} & 第 5 章 SymPy 简介，适合数据方向学生
& 第2章 SymPy \\
\href{https://github.com/huahbo/python_computing}{intro-mathmodel 第 1
章 Numpy 与线性代数} & 下游对齐 & 附录 \\
\href{https://mml-book.github.io/}{mml-book Chapter 2/3/4} &
线性代数/解析几何/矩阵分解 & 附录 \\
\href{https://github.com/AllenDowney/ThinkStats2}{thinkstats2} & 用
Python 讲统计 & 附录 \\
\href{https://github.com/huahbo/python_computing}{上游开源教材（科学计算）}
& 本书开源仓库，含本章代码 & 第7章 Statsmodels \\
\href{https://github.com/huahbo/python_computing}{南瓜书（《机器学习》公式推导）}
& 与周志华《机器学习》配套的公式推导详解 & 第8章 scikit-learn \\
\href{https://github.com/huahbo/python_computing}{开源社区
图深度学习（葡萄书）} & 中文开源书，进阶图神经网络 & 第6章 NetworkX \\
\href{https://github.com/huahbo/python_computing}{开源社区 数学建模导论}
& 后续课程（Pandas 实战） & 第4章 Pandas \\
\href{https://github.com/huahbo/python_computing}{数学建模导论} &
后续课程 & 第1章 NumPy \\
\href{https://github.com/huahbo/python_computing}{数学建模导论（后续）}
& 大量 SciPy 建模案例 & 第3章 SciPy \\
\href{https://github.com/huahbo/python_computing}{本项目（《Python
科学计算》）} & 本书开源仓库 & 第8章 scikit-learn \\
\href{https://github.com/huahbo/python_computing}{本项目（科学计算）} &
本书开源仓库 & 第1章 NumPy、第2章 SymPy、第3章 SciPy、第4章
Pandas、第5章 Matplotlib \\
\href{https://github.com/huahbo/python_computing}{李宏毅机器学习（开源社区整理）}
& 中文讲义，串起 ML 与 DL 的``为什么'' & 第8章 scikit-learn \\
\href{https://github.com/huahbo/python_computing}{李宏毅机器学习（开源社区）}
& 中文讲义，机器学习到深度学习衔接 & 第8章 scikit-learn \\
\end{longtable}
}
...
on Scientific Computing} & Lecture 4 讲 statsmodels 回归 & 第7章
Statsmodels \\
\href{https://github.com/jrjohansson/scientific-python-lectures}{Lectures
on Scientific Computing (Robert Johansson)} &
Lecture-2-Numpy.ipynb，Notebook 形式 & 第1章 NumPy、第2章 SymPy、第4章
Pandas、第6章 NetworkX \\
...
\href{https://scipy-lectures.org/}{SciPy Lecture Notes（Pandas 章节）} &
偏科学计算，含数据整理 & 第4章 Pandas \\
\href{https://scipy-lectures.org/}{SciPy Lecture Notes（网络章节）} &
科学计算整体，含图与网络 & 第6章 NetworkX \\
\href{https://scipy-lectures.org/}{SciPy Lectures -- Numpy / Linear
algebra} & 数值实现视角 & 附录 \\
\href{https://scipy-lectures.org/}{SciPy Lectures -- Optimization /
Integration} & 优化/积分/ODE 实用教程 & 附录 \\
\href{https://scipy-lectures.org/packages/sympy.html}{SciPy Lectures --
SymPy} & 系统、带例子，覆盖符号计算核心 & 第2章 SymPy \\
\href{https://scipy-lectures.org/}{SciPy-lectures 练习} & 每节配练习 &
第3章 SciPy \\
\href{https://github.com/jrjohansson/scientific-python-lectures}{Scientific
Python Lectures (GitHub)} & Lecture-3-Scipy.ipynb，Notebook 形式 & 第3章
SciPy \\
...
\href{https://inria.github.io/scikit-learn-mooc/}{scikit-learn MOOC
习题} & 在线交互 Quiz + Notebook & 第8章 scikit-learn \\
...
Matplotlib \\
\href{https://github.com/huahbo/python_computing}{开源社区 wow-plotly} &
Plotly 交互式教程（对比阅读） & 第5章 Matplotlib \\
\href{https://github.com/huahbo/python_computing}{开源社区 聪明办法学
Python v2} & 前置 Python 课程 & 第4章 Pandas、第8章 scikit-learn \\
...
\href{https://github.com/huahbo/python_computing}{社区时间序列相关笔记}
& 时间序列特征与规则入门 & 第7章 Statsmodels \\
\href{https://github.com/huahbo/python_computing}{聪明办法学 Python v2}
& 前置课程 & 第1章 NumPy、第2章 SymPy、第7章 Statsmodels \\
\href{https://github.com/huahbo/python_computing}{聪明办法学 Python
v2（开源社区）} & 前置课程：Chap0 安装、Chap1 启航、Chap2-6 基础语法 &
第0章 前置基础 \\
\href{https://github.com/huahbo/python_computing}{聪明办法学
Python（前置）} & 前置课程 & 第3章 SciPy、第5章 Matplotlib \\
\end{longtable}
}
...
\href{https://github.com/ageron/handson-ml3}{Hands-On ML 练习} &
每章自带练习（含答案） & 第8章 scikit-learn \\
...
\bottomrule\noalign{}
\endlastfoot
\href{https://github.com/huahbo/python_computing}{Grape-book（图深度学习）}
& 图神经网络进阶（延伸） & 第6章 NetworkX \\
\href{https://github.com/wesm/pydata-book}{Python for Data Analysis 3rd
(Wes McKinney)} & Pandas 作者亲著，第三版配套代码 & 第4章 Pandas \\
\href{https://github.com/wesm/pydata-book}{Python for Data Analysis（Wes
McKinney）} & 14 章包含 statsmodels 回归示例 & 第7章 Statsmodels \\
\href{https://github.com/dair-ai/Mathematics-for-ML}{dair-ai/Mathematics-for-ML}
& 按主题收集资源的清单 & 附录 \\
\href{https://github.com/huahbo/python_computing}{intro-mathmodel 第 4
章 复杂网络与图论模型} & 下游对齐 & 附录 \\
\href{https://github.com/huahbo/python_computing}{intro-mathmodel 第 7
章（权重/评价）、第 9 章（统计模型）} & 下游对齐 & 附录 \\
...
\href{https://mml-book.github.io/}{mml-book Part II} &
回归/分类/概率视角 & 附录 \\
\end{longtable}
}
