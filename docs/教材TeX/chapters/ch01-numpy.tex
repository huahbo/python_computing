...
\BuiltInTok{print}\NormalTok{(}\StringTok{"coef (截距, 斜率):"}\NormalTok{, coef)}
\BuiltInTok{print}\NormalTok{(}\StringTok{"残差平方和:"}\NormalTok{, res[}\DecValTok{0}\NormalTok{])}
\BuiltInTok{print}\NormalTok{(}\StringTok{"rank:"}\NormalTok{, rank\_)}
\BuiltInTok{print}\NormalTok{(}\StringTok{"来自 np.polyfit 的对照:"}\NormalTok{, np.polyfit(height, weight, }\DecValTok{1}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{残差平方和: 92.68917264143425}
\NormalTok{rank: 2}
