...
\textbf{一句话人话}：先画一张``人=点、一起学习=连线''的网；每条线还能记一个数（每周讨论几次），这样不但知道``谁朋友多''，还知道``谁和朋友来往最勤''。
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={班级社交网}]{figures/06-networkx/case1_class_network.png}}
\caption{班级社交网}
\end{figure}
...
\textbf{一句话人话}：度问``你认识几个人''；介数问``别人找你帮忙传话的次数多不多''；接近问``你要想联系到所有人，平均要走几步''。
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={三种中心性对比}]{figures/06-networkx/case2_centrality.png}}
\caption{三种中心性对比}
\end{figure}
...
\textbf{一句话人话}：每条地铁线都标上``坐多久''，Dijkstra
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={地铁最少时间路线}]{figures/06-networkx/case3_metro.png}}
\caption{地铁最少时间路线}
\end{figure}
