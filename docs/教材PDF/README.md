...
| 文件 | 章节 | 页数 |
| ---- | ---- | ---- |
| `09-agent-basics-AI Agent 编程基础.pdf` | 9 AI Agent 编程基础 | 26 页 |
| `10-agent-workflow-Agent 工作流与验证方法.pdf` | 10 Agent 工作流与验证方法 | 14 页 |
| `11-agent-cases-案例实战：从修 bug 到端到端项目.pdf` | 11 案例实战 | 20 页 |
| `12-agent-engineering-工程化与持续演进.pdf` | 12 工程化与持续演进 | 8 页 |
| `第二部分-AI-Agent编程.pdf` | 第二部分合并（含部分封面） | 69 页 |

## 全书与附录

| 文件 | 内容 | 页数 |
| ---- | ---- | ---- |
| `Python科学计算_全书.pdf` | 全书（第 0–12 章 + 附录 A–G，含两部分分隔页） | 372 页 |
