...
> 所有代码均可在 matplotlib ≥ 3.8、seaborn ≥ 0.13 环境运行；配图由 `build/make_chap5_figures.py` 生成。
...
- Matplotlib 多子图：https://matplotlib.org/stable/tutorials/intermediate/subplots.html
- Seaborn 分布图：https://seaborn.pydata.org/generated/seaborn.histplot.html
