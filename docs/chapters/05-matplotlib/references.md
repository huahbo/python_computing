...
| 课程仓库参考（原：开源社区 fantastic-matplotlib） | [链接](https://github.com/huahbo/python_computing) | 中文、渐进式 Matplotlib 教程 | 中文补充 |
| 课程仓库参考（原：开源社区 wow-plotly） | [链接](https://github.com/huahbo/python_computing) | Plotly 交互式教程（对比阅读） | 选读 |
...
| 课程仓库参考（原：开源社区 fantastic-matplotlib） | [链接](https://github.com/huahbo/python_computing) | 中文精品教程，适合入门 |
| 课程仓库参考（原：聪明办法学 Python（前置）） | [链接](https://github.com/huahbo/python_computing) | 前置 Python 课程 |
