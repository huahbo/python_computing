...
| 李宏毅机器学习（开源社区整理） | [链接](https://github.com/datawhalechina/leedl-tutorial) | 中文讲义，串起 ML 与 DL 的“为什么” | 选读 |
...
| 李宏毅机器学习（开源社区） | [链接](https://github.com/datawhalechina/leedl-tutorial) | 中文讲义，机器学习到深度学习衔接 | ★推荐 |
| 开源社区 聪明办法学 Python v2 | [链接](https://github.com/datawhalechina/learn-python-the-smart-way-v2) | 前置 Python 复习 | 选读 |
