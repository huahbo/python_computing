...
| 案例卡 | 所在节 | 技术点 | 难度 |
| ---- | ---- | ---- | ---- |
| 1. 特征编码与缩放——为什么先 fit 再 transform | [01 数据集的预处理](./01-数据集的预处理.md) | OneHotEncoder、StandardScaler、fit/transform、防泄漏 | ★★☆ |
| 2. 分类流水线——Iris 用 KNN+标准化+Pipeline 防数据泄漏 | [02 有监督学习的案例](./02-有监督学习的案例.md) | Pipeline、StandardScaler、KNN、cross_val_score | ★★☆ |
| 3. KMeans 与 PCA——用肘部法则评估聚类数并做 2D 可视化 | [03 无监督学习的案例](./03-无监督学习的案例.md) | KMeans、inertia、PCA、silhouette/ARI | ★★☆ |
| 4. Wine 数据端到端——预处理→分类→聚类→降维→可视化 | [04 综合案例](./04-综合案例.md) | Pipeline、特征重要性、KMeans、PCA | ★★★ |

## 本章目录

| 小节 | 文件 | 内容 |
| ---- | ---- | ---- |
| 01 数据集的预处理 | [01-数据集的预处理.md](./01-数据集的预处理.md) | 特征编码、特征缩放、数据集切分、交叉验证、特征选择与降维概览（案例卡 1） |
| 02 有监督学习的案例 | [02-有监督学习的案例.md](./02-有监督学习的案例.md) | Iris 分类、乳腺癌二分类、Diabetes 回归、决策树可视化、评估指标（案例卡 2） |
| 03 无监督学习的案例 | [03-无监督学习的案例.md](./03-无监督学习的案例.md) | KMeans / DBSCAN 聚类、PCA / LDA 降维、聚类与降维评估（案例卡 3） |
| 04 综合案例 | [04-综合案例.md](./04-综合案例.md) | Wine 数据端到端：预处理→分类→聚类→降维→可视化（配图，案例卡 4） |
