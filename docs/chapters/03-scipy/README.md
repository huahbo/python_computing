...
| 案例卡 | 所在节 | 技术点 | 难度 |
| ---- | ---- | ---- | ---- |
| 1. 用 quad 求定积分并和数值微积分结果对照 | [01 微积分工具包](./01-微积分工具包.md) | quad、trapezoid、自适应积分 | ★☆☆ |
| 2. 用 curve_fit 拟合实验数据并解释参数含义 | [02 优化工具包](./02-优化工具包.md) | curve_fit、pcov、参数标准误、RMSE | ★★☆ |
| 3. 一维插值 vs 多项式拟合：缺失值用 CubicSpline 补全 | [03 插值工具包](./03-插值工具包.md) | CubicSpline、polyfit、RMSE | ★★☆ |
| 4. 综合案例：传感器信号分析 | [06 综合案例](./06-综合案例.md) | 插值 + FFT + 拟合 + 积分 + 检验 | ★★★ |
