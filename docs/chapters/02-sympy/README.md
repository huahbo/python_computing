...
本章的微积分/方程背景已集中到附录《数学与算法补充》：

- **B 微积分与数值方法**：B.1 微积分直觉、B.2 关键公式速查、B.3.5 常微分方程；
- **A 线性代数与矩阵**：A.3 特征值分解（SymPy 解特征问题）；
- [打开附录 B](./../../附录/数学算法附录/B-微积分与数值方法.md) ｜ [附录索引](./../../附录/数学算法附录/README.md)

> 做极限/导数/积分/方程求解前，先读 B.1 与 B.2 的公式表。
