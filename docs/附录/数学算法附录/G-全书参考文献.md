...
| [GLM](https://www.statsmodels.org/stable/generated/statsmodels.genmod.generalized_linear_model.GLM.html) | 广义线性模型 | 第7章 Statsmodels |
| [Git 官方文档](https://git-scm.com/doc) | 书/命令/教程 | 第0章 前置基础 |
| [I/O 参考](https://numpy.org/doc/stable/reference/routines.io.html) | save/loadtxt/savez | 第1章 NumPy |
| [Jupyter 官方文档](https://docs.jupyter.org/en/latest/) | 笔记本/内核/导出 | 第0章 前置基础 |
...
| [Pandas 10 分钟入门](https://pandas.pydata.org/docs/user_guide/10min.html) | 一分钟建立 Series/DataFrame 心智 | 第4章 Pandas |
| [Pandas Cheat Sheet（官方）](https://pandas.pydata.org/Pandas_Cheat_Sheet.pdf) | 一页速查 | 第4章 Pandas |
| [Pandas 中文入门（pandas.pydata.org 官方中文翻译入口）](https://pandas.pydata.org/docs/) | 官方文档，含中文化镜像 | 第4章 Pandas |
| [Pandas 官方主页](https://pandas.pydata.org/) | 库主页、版本、安装 | 第4章 Pandas |
| [Pandas 用户指南](https://pandas.pydata.org/docs/user_guide/index.html) | 索引/清洗/分组/时间序列全指南 | 第4章 Pandas |
| [Pro Git 中文版](https://git-scm.com/book/zh/v2) | 系统化学习 | 第0章 前置基础 |
| [Pyplot 教程](https://matplotlib.org/stable/tutorials/pyplot.html) | 函数式接口与状态机说明 | 第5章 Matplotlib |
| [Python 官方教程（中文）](https://docs.python.org/zh-cn/3/tutorial/) | 语法查漏的第一权威 | 第0章 前置基础 |
...
| [SymPy Gotchas（常见坑）](https://docs.sympy.org/latest/tutorial/gotchas.html) | 官方 FAQ，避开符号计算陷阱 | 第2章 SymPy |
| [SymPy Matrices](https://docs.sympy.org/latest/modules/matrices/index.html) | 符号矩阵、特征值、分解 | 第2章 SymPy |
| [SymPy ODE (dsolve)](https://docs.sympy.org/latest/modules/solvers/ode.html) | 微分方程符号求解 | 第2章 SymPy |
| [SymPy Solvers](https://docs.sympy.org/latest/modules/solvers/index.html) | solve/solveset/linsolve/nonlinsolve 参考 | 第2章 SymPy |
| [SymPy Tutorials（总目录）](https://docs.sympy.org/latest/tutorials/index.html) | 官方入门教程入口，含基础与进阶 | 第2章 SymPy |
| [SymPy lambdify](https://docs.sympy.org/latest/modules/utilities/lambdify.html) | 符号→数值函数的关键工具 | 第2章 SymPy |
| [SymPy 官方 1.13 文档](https://docs.sympy.org/latest/index.html) | 完整 API 参考 | 第2章 SymPy |
| [SymPy 官方 doc 中的 Examples](https://docs.sympy.org/latest/tutorials/intro-tutorial/) | 每条均可上机复现 | 第2章 SymPy |
| [TSA（时间序列）](https://www.statsmodels.org/stable/tsa.html) | 时间序列模块总览 | 第7章 Statsmodels |
| [TeX Live 下载](https://www.tug.org/texlive/acquire-netinstall.html) | Windows 安装器 | 第0章 前置基础 |
| [User Guide](https://www.statsmodels.org/stable/user-guide.html) | 全书式教学指南 | 第7章 Statsmodels |
| [VS Code Python 入门](https://code.visualstudio.com/docs/python/python-tutorial) | 从新建文件到运行调试 | 第0章 前置基础 |
| [VS Code Python 环境官方文档](https://code.visualstudio.com/docs/python/environments) | 解释器/虚拟环境/内核原理 | 第0章 前置基础 |
| [VS Code 官方下载](https://code.visualstudio.com/) | 编辑器 | 第0章 前置基础 |
| [WLS](https://www.statsmodels.org/stable/generated/statsmodels.regression.linear_model.WLS.html) | 加权最小二乘 | 第7章 Statsmodels |
| [adfuller](https://www.statsmodels.org/stable/generated/statsmodels.tsa.stattools.adfuller.html) | ADF 单位根检验 | 第7章 Statsmodels |
...
| [图生成器](https://networkx.org/documentation/stable/reference/generators.html) | path/cycle/complete/karate/随机图 | 第6章 NetworkX |
| [图类型（Graph / DiGraph 等）](https://networkx.org/documentation/stable/reference/classes/index.html) | Graph / DiGraph / MultiGraph 接口 | 第6章 NetworkX |
| [安装 Miniconda](https://docs.conda.io/en/latest/miniconda.html) | 官方下载入口（速度慢用清华镜像） | 第0章 前置基础 |
| [官方示例：空手道俱乐部](https://networkx.org/documentation/stable/auto_examples/graph/plot_karate_club.html) | 经典社区网络可视化 | 第6章 NetworkX |
| [性能提升](https://pandas.pydata.org/docs/user_guide/enhancingperf.html) | 向量化、chunksize 等 | 第4章 Pandas |
| [时间序列 STL 示例](https://www.statsmodels.org/devel/examples/notebooks/generated/stl_decomposition.html) | LOESS 季节性-趋势分解 | 第7章 Statsmodels |
| [时间序列指南](https://pandas.pydata.org/docs/user_guide/timeseries.html) | date_range/resample/rolling | 第4章 Pandas |
| [最小生成树](https://networkx.org/documentation/stable/reference/algorithms/tree.html) | minimum_spanning_tree 等 | 第6章 NetworkX |
| [最短路径算法](https://networkx.org/documentation/stable/reference/algorithms/shortest_paths.html) | Dijkstra / Bellman-Ford / Floyd-Warshall | 第6章 NetworkX |
| [社区检测与模块度](https://networkx.org/documentation/stable/reference/algorithms/community.html) | greedy_modularity / louvain / modularity | 第6章 NetworkX |
| [算法总览](https://networkx.org/documentation/stable/reference/algorithms/index.html) | 全部算法模块入口 | 第6章 NetworkX |
| [绘图 API](https://networkx.org/documentation/stable/reference/drawing.html) | draw / spring_layout / 自定义 | 第6章 NetworkX |
| [缺失值处理](https://pandas.pydata.org/docs/user_guide/missing_data.html) | isna/fillna/dropna/ffill/bfill | 第4章 Pandas |
| [连通性](https://networkx.org/documentation/stable/reference/algorithms/connectivity.html) | is_connected / 强连通 / 分量 | 第6章 NetworkX |
| [随机数（Generator）](https://numpy.org/doc/stable/reference/random/generator.html) | `default_rng` 用法 | 第1章 NumPy |
| [面向对象接口](https://matplotlib.org/stable/tutorials/introductory/usage.html#the-object-oriented-interface) | Figure/Axes 对象模型权威定义 | 第5章 Matplotlib |
...
| [SciPy Cookbook](https://scipy.github.io/old-wiki/pages/Cookbook/) | 大量实战小例子（老但仍有效） | 第3章 SciPy |
| [numpy_exercises by 4GeeksAcademy](https://github.com/4GeeksAcademy/numpy-100) | 在线运行版本（Binder 友好） | 第1章 NumPy |
...
| 资料 | 说明 | 用于 |
| ---- | ---- | ---- |
| [Big-O Cheat Sheet](https://www.bigocheatsheet.com/) | 常用复杂度速查 | 附录 |
| [Optimization and Fit Cookbook](https://scipy.github.io/old-wiki/pages/Cookbook/OptimizationAndFitDemo1.html) | 拟合示例详解 | 第3章 SciPy |
...
| 章节 | 直接查看该章参考 |
| ---- | ---- |
| 第0章 前置基础 | [references.md](../../chapters/00-prep/references.md) |
| 第1章 NumPy | [references.md](../../chapters/01-numpy/references.md) |
| 第2章 SymPy | [references.md](../../chapters/02-sympy/references.md) |
| 第3章 SciPy | [references.md](../../chapters/03-scipy/references.md) |
| 第4章 Pandas | [references.md](../../chapters/04-pandas/references.md) |
| 第5章 Matplotlib | [references.md](../../chapters/05-matplotlib/references.md) |
| 第6章 NetworkX | [references.md](../../chapters/06-networkx/references.md) |
| 第7章 Statsmodels | [references.md](../../chapters/07-statsmodels/references.md) |
| 第8章 scikit-learn | [references.md](../../chapters/08-sklearn/references.md) |
